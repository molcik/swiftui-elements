...
//                                URLImage(albums[0].picture.uri, content: { image in
//                                    image
...
//                            .frame(height: height/2)
//                            .foregroundColor(Color.white).background(
//                                URLImage(albums[1].picture.uri, content: { image in
//                                    image
//                                        .renderingMode(.original)
//                                        .resizable()
//                                })
...
//                            .frame(height: height/2)
//                            .foregroundColor(Color.white).background(
//                                URLImage(albums[2].picture.uri, content: { image in
//                                    image
//                                        .renderingMode(.original)
//                                        .resizable()
//                                })
...
//                            .frame(height: height/2)
//                            .foregroundColor(Color.white).background(
//                                URLImage(albums[3].picture.uri, content: { image in
//                                    image
//                                        .renderingMode(.original)
//                                        .resizable()
//                                })
