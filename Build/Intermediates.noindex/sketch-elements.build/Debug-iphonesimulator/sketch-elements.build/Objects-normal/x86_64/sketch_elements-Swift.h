...
#ifndef SKETCH_ELEMENTS_SWIFT_H
#define SKETCH_ELEMENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="sketch_elements",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15sketch_elements11AppDelegate")
...
SWIFT_CLASS("_TtC15sketch_elements11Coordinator")
...
SWIFT_CLASS("_TtC15sketch_elements13SceneDelegate")
